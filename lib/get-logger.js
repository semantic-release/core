...
export default ({ stdout, stderr }) =>
  new Signale({
    ...
    types: {
      ...
      start: { badge: figures.triangleRight, color: "green", label: "", stream: [stdout] },
      skip: { badge: figures.arrowRight, color: "cyan", label: "", stream: [stdout] },
      complete: { badge: figures.squareCenter, color: "blue", label: "", stream: [stdout] },
    },
  });
